...
export default function WithdrawalForm() {
  ...
  const canSubmit = isValidAmount && !withdrawalMutation.isPending
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Input
        ...
        required
        error={
          amount && !isNaN(numAmount) && numAmount > numBalance
      ...
      <Button type="submit" disabled={!canSubmit} loading={withdrawalMutation.isPending} className="w-full">
        Withdraw
      </Button>
    </form>
  )
