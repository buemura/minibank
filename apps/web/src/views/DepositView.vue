...
import DepositForm from '@/components/transaction/DepositForm.vue'
...
<template>
  <div class="min-h-screen">
    ...
    <main class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Make a Deposit</h1>
        <p class="text-gray-600 dark:text-gray-400">Add funds to your account.</p>
      </div>
